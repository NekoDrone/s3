ALTER TABLE `accounts` RENAME COLUMN "account" TO "identifier";--> statement-breakpoint
...
CREATE TABLE `__new_scheduled_posts` (
	...
	FOREIGN KEY (`account`) REFERENCES `accounts`(`identifier`) ON UPDATE no action ON DELETE no action
);
