...
ALTER TABLE `accounts` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT (unixepoch('now'));--> statement-breakpoint
...
ALTER TABLE `scheduled_posts` ALTER COLUMN "created_at" TO "created_at" integer NOT NULL DEFAULT (unixepoch('now'));